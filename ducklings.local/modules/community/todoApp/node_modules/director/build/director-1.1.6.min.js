...
(function (a) {
  ...
  var b = document.location, d = {mode:"modern", hash:b.hash, history:!1, check:function () {
    ...
    if (this instanceof e) {
      this.params = {}, this.routes = {}, this.methods = ["on", "once", "after", "before"], this._methods = {}, this._insert = this.insert, this.insert = this.insertEx, this.historySupport = (window.history != null ? window.history.pushState : null) != null, this.configure(), this.mount(a || {});
    } else {
      return new e(a)
    }
  };
