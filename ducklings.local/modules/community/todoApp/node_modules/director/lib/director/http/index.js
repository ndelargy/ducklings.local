var events = require('events'), qs = require('querystring'), util = require('util'), director = require('../../director'), responses = require('./responses');
...
Router.prototype.dispatch = function (req, res, callback) {
  ...
  //
  var method = req.method === 'HEAD' ? 'get' : req.method.toLowerCase(), thisArg = { req:req, res:res }, self = this, contentType, runlist, stream, error, fns, url;
